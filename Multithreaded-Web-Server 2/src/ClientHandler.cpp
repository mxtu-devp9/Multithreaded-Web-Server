...
std::string dashboardHtml() {
    return
        ...
        "let res=await fetch('/status?time='+Date.now());"
        ...
        "let pq=document.getElementById('priorityQueue');"
        "let nq=document.getElementById('normalQueue');"

        "p.innerText=d.priority;"
        "n.innerText=d.normal;"
        "pq.innerText=d.priority;"
        "nq.innerText=d.normal;"

        "p.style.fontWeight='bold';"
        "n.style.fontWeight='bold';"
        "pq.style.fontWeight='bold';"
        "nq.style.fontWeight='bold';"

        "if(d.priority.includes('PROCESSING')||d.priority.includes('PRIORITY')){"
        "p.style.color='#ef4444';"
        "pq.style.color='#ef4444';"
        "}else if(d.priority.includes('COMPLETED')){"
        "p.style.color='#22c55e';"
        "pq.style.color='#22c55e';"
        "}else{"
        "p.style.color='#facc15';"
        "pq.style.color='#facc15';"
        "}"

        "if(d.normal.includes('PAUSED')){"
        "n.style.color='#ef4444';"
        "nq.style.color='#ef4444';"
        "}else{"
        "n.style.color='#22c55e';"
        "nq.style.color='#22c55e';"
        "}"
